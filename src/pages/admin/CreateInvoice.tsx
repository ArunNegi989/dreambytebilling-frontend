...
const CreateInvoice: React.FC = () => {
  ...
  const [ackDate, setAckDate] = useState<string>(() => new Date().toISOString().slice(0, 10));

  // ---- Invoice meta ----
  const [gstin, setGstin] = useState(supplierGstin);
  const [invoiceNo, setInvoiceNo] = useState("");
  const [dateOfInvoice, setDateOfInvoice] = useState<string>(() => new Date().toISOString().slice(0, 10));
  ...
  const [billedToName, setBilledToName] = useState("DREAMBYTE SOLUTIONS (OPC) PRIVATE LIMITED");
...
useEffect(() => {
  ...
  const quickError = useMemo(() => validateQuick(), [invoiceNo, dateOfInvoice, billedToName, items]);
  ...
  const handleSubmit = async (e?: React.FormEvent) => {
    ...
    if (v) {
      setTopError(v);
      const bad = items.find((it) => !it.location || !it.sacHsn || !it.specification || it.qty <= 0);
      ...
      <div className={styles.left}>
        ...
        <header className={styles.header}>
          ...
          <div className={styles.headerActions}>
            <button type="button" className={styles.ghost} onClick={() => navigate(-1)}>
              Cancel
            </button>
            <button
              type="button"
          ...
          <section className={styles.card}>
            <div className={styles.metaRow}>
              ...
              <label>
                ...
                <input type="date" value={dateOfInvoice} onChange={(e) => setDateOfInvoice(e.target.value)} />
              </label>
            </div>
            ...
            <div className={styles.metaRow}>
              <label>
                ...
                <select
                  ...
                  style={{ padding: "8px 10px", borderRadius: 8, border: "1px solid #e6e6e6", background: "#fff", color: "#111" }}
                >
              ...
              <label>
                ...
                <input value={clientOrderNo} onChange={(e) => setClientOrderNo(e.target.value)} />
              </label>
  ...
  <div className={styles.billingSection}>
    ...
    <div className={styles.columnLeft}>
      <div className={styles.sectionHeader}>
        ...
        <div className={styles.sectionSubtitle}>Enter billing details here</div>
      </div>
      ...
      <div className={styles.rowGrid}>
        <div>
          ...
          <input className={styles.textInput} value={campaign} onChange={(e) => setCampaign(e.target.value)} />
        </div>
    ...
    <div className={styles.columnRight}>
      ...
      <label className={styles.formField}>
        <input
          className={styles.textInput}
          value={shipToName}
          onChange={(e) => { setShipToName(e.target.value); if (sameAsBilling) setSameAsBilling(false); }}
      ...
      <label className={`${styles.formField} ${styles.textareaField}`}>
        <textarea
          ...
          rows={3}
          value={shipToAddress}
          onChange={(e) => { setShipToAddress(e.target.value); if (sameAsBilling) setSameAsBilling(false); }}
      ...
      <label className={styles.formField}>
        ...
        <input className={styles.textInput} value={partyPan} onChange={(e) => setPartyPan(e.target.value)} placeholder="Party PAN" />
      </label>
      ...
      <aside className={styles.right}>
        <div className={styles.summaryCard}>
          ...
          <div className={styles.summaryActions}>
            ...
            <button type="button" className={styles.ghostFull} onClick={() => window.print()}>
              Print Preview
            </button>
          </div>
